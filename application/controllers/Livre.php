...
class Livre extends CI_Controller {
    ...
    function __construct() {
        parent::__construct();//Code Partiel
    ...
    // Enlever $tri=NULL des paamètres de la fonction car la pagination ne marchera plus    
    // Utiliser $POST
    //Pour permettre à l'utilisateur de choisir le critère de tri
    //Marche selon l'ordre de tri défini dans get_all_livres() LivreModel.php  
        ...
        $data['livres']=$this->livreModel->get_all_livres($page,$config['per_page'],  filter_input(INPUT_POST, $tri));
